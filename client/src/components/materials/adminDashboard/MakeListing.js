                    ...
                    <form onSubmit={e => this.formSubmit(e)}>
                        <FormGroup>
                            ...
                            <Grid item="item" xs="xs">
                                <TextField onChange={() => this.handleTextChange("description")} multiline="multiline" rowsMax="4" required="required" id="listing-description" label="Description" className={classes.textField} margin="normal"/> {/* <TextField required="required" id="listing-tags" label="Required" defaultValue="Hello World" className={classes.textField} margin="normal"/> */}
                            </Grid>
                            <Divider/>
                            <Grid item="item" xs="xs">
